...
exportAsPDF(){
    ...
    doc.setFontSize(14);
    doc.text("Autorité de Régulation des \nPostes et Télécommunications" , 45, 15);
  
    doc.setFontSize(12);
    doc.text("REPUBLIQUE DE GUINEE" , 155, 15);
    doc.setFontSize(10);
    doc.text("TRAVAIL - JUSTICE - SOLIDARITE" , 150, 20);
  ...
  doc.text(15,288, "ARPT - Centre Directionnel de Koloma, BP 1500, Conakry, Commune de Ratoma, E-mail : contact@arpt.gov.gn, Site Web: www.arpt.gov.gn");
  doc.text(80,294, "");
  }
